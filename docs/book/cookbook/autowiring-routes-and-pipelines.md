...
Mezzio 2.0 switches to _programmatic_ pipelines and routes, versus
...
One possibility, available since the Mezzio 2.X skeleton application, is to
use _delegator factories_ on the `Mezzio\Application` instance in order
