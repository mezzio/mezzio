...
>
> Starting in Mezzio 3.0, we added support for
...
> 
> Middleware using the double-pass style is accepted only by Mezzio 1.X and
> 2.X, and no longer directly supported in Mezzio 3.X. You may use
> `Laminas\Stratigility\Middleware\DoublePassMiddlewareDecorator` in order to
> decorate such middleware for use in Mezzio 3.X.
