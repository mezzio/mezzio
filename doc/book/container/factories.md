...
- **Provides**: `Mezzio\Template\Plates`
- **FactoryName**: `Mezzio\Container\Template\PlatesFactory`
- **Suggested Name**: `Mezzio\Template\TemplateInterface`
- **Requires**: no additional services are required.
- **Optional**:
    - `config`, an array or `ArrayAccess` instance. This will be used to further
...
- **Provides**: `Mezzio\Template\Twig`
- **FactoryName**: `Mezzio\Container\Template\TwigFactory`
- **Suggested Name**: `Mezzio\Template\TemplateInterface`
- **Requires**: no additional services are required.
- **Optional**:
    - `Mezzio\Router\RouterInterface`; if found, it will be used to
      seed a `Mezzio\Template\Twig\TwigExtension` instance for purposes
...
- **Provides**: `Mezzio\Template\LaminasView`
- **FactoryName**: `Mezzio\Container\Template\LaminasViewFactory`
- **Suggested Name**: `Mezzio\Template\TemplateInterface`
- **Requires**: no additional services are required.
...
serverurl helpers, `Mezzio\Template\LaminasView\UrlHelper` and
`Mezzio\Template\LaminasView\ServerUrlHelper`, respetively.
