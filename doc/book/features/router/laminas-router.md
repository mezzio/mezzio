...
$container->addFactory(
    Laminas\Mvc\Router\Http\TreeRouteStack::class,
...
return [
    'factories' => [
        Laminas\Mvc\Router\Http\TreeRouteStack::class => App\Container\TreeRouteStackFactory::class,
...
$container[Laminas\Mvc\Router\Http\TreeRouteStackFactory::class] = new TreeRouteStackFactory();
